<div class="btn-group">
    <a href="{{ route('admin.cms.article.show', [$data->id]) }}" type="button" class="btn btn-default">
        <i class="fas fa-eye"></i>
    </a>
    <a href="{{ route('admin.cms.article.edit', [$data->id]) }}" type="button" class="btn btn-default">
    ...
    {!! Form::open(['url' => route('admin.cms.article.destroy', [$data->id]), 'method' => 'delete', 'id' => 'delete_form' . $data->id]) !!}{!! Form::close() !!}
</div>
