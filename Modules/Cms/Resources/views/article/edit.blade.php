            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-gray-dark card-outline">
                        ...
                        {!! Form::open(['url' => route('admin.cms.article.update', [$article->id]), 'method' => 'put', 'files' => true]) !!}
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="title" class="@error('title') text-danger @enderror">Title</label>
                                        <input id="title" name="title" value="{{ old('title') ?: $article->title }}" type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Enter title" autofocus>
                                        @error('title')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="details" name="details" class="form-control summernote" rows="3" placeholder="Enter article body">{{ old('details') ?: $article->details }}</textarea>
                                        @error('details')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="external_link" name="external_link" value="{{ old('external_link') ?: $article->external_link }}" type="text" class="form-control @error('external_link') is-invalid @enderror" placeholder="Enter article url" autofocus>
                                        @error('external_link')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
